...
public class UpdateReminders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        final String id=i.getStringExtra("rid");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String time1 = time.getText().toString().trim();
                    ...
                    processiUpdate(id,task1,date1,time1);



//               int time=Integer.parseInt(ed1.getText().toString());
//                int date=Integer.parseInt(ed1.getText().toString());
//                long ttime = System.currentTimeMillis()+(time*1000);
//                Intent bi = new Intent(MainActivity.this, myreciver.class);
//                PendingIntent pi = PendingIntent.getBroadcast(MainActivity.this,Al_UQ,bi,PendingIntent.FLAG_UPDATE_CURRENT);
//                alarmManager.set(AlarmManager.RTC_WAKEUP,ttime,pi);
            }
        });
    ...
    private void processiUpdate(String id ,String task, String date, String time) {
        String result = new dbManager(this).updateReminders(id,task, date, time);
